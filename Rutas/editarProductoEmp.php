...
if($nombre == "" || $precio_unitario == "" || $categoria == ""){
    ...
    header('Location: ../Rutas/editarProEmp.php?id=' . $id_producto . '&categoria=' . $categoria . ' &nombre=' . $nombre . '&imagen=' . $imagen1 . '&precio_unitario=' . $precio_unitario); 
...
elseif ($categoria == "Carne") {
        ...
        header('Location: ../Vista/productoEmp.php');
        exit();
